...
const Formulario = () => {
    ...
    return (  
        <div className="w-full mt-10">
            ...
            <div>
                <select 
                    className="overflow-visible appearance-none w-full mt-2 bg-white border border-gray-400 text-black py-3 px-4 pr-8 rounded leading-none focus:outline-none focus:border-gray-500"
